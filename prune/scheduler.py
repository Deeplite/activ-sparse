...
This file is based on code from TensorFlow (Copyright 2019 The TensorFlow
Authors), which is licensed under the Apache License, Version 2.0.
Modifications and additions have been made by Deeplite Inc.
"""
...
class _Scheduler(ABC):
    ...
    def should_do(self, step):
        ...
        Pruning should only occur within the [`begin_step`, `Inf`] range
